...
public class CalcStepsDefinitions extends Variaveis{	
	...
	public void o_resultado_da_adicao_deve_ser(Integer int1) {
		assertEquals(Variaveis.num1Adicao + Variaveis.num2Adicao, calculadora.Adicao(Variaveis.num1Adicao, Variaveis.num2Adicao) );
	}

	@Dado("que o usuario subraia {int} de {int}")
	...
	public void o_resultado_da_subtracao_deve_ser(Integer int1) {
		assertEquals(Variaveis.num1Subtracao - Variaveis.num2Subtracao, calculadora.Subtracao(Variaveis.num1Subtracao, Variaveis.num2Subtracao) );
	}
	...
	public void o_resultado_da_multiplicacao_deve_ser(Integer int1) {
		assertEquals(Variaveis.num1Multiplicacao + Variaveis.num2Multiplicacao, calculadora.Multiplicacao(Variaveis.num1Multiplicacao, Variaveis.num2Multiplicacao) );
	}
	...
	public void o_resultado_da_divisao_deve_ser(Integer int1) {
		assertEquals(Variaveis.num1Divisao / Variaveis.num2Divisao, calculadora.Divisao(Variaveis.num1Divisao, Variaveis.num2Divisao) );
	}
